...
class Motor(models.Model):
    latitude = models.ForeignKey(Airport, on_delete=models.CASCADE)
    longitude = models.ForeignKey(Airport, on_delete=models.CASCADE, related_name='destination_airport')
...
class Travel(models.Model):
    ...
    Motor = models.ForeignKey(Flight, on_delete=models.PROTECT)
